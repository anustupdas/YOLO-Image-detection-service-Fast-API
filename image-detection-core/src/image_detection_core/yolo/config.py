...
__C.YOLO.CLASSES              = DEFAULT_YOLO_CLASS_FILE
...
__C.TRAIN.ANNOT_PATH          = DEFAULT_YOLO_ANNOTATION_FILE
...
__C.TEST.ANNOT_PATH           = DEFAULT_YOLO_ANNOTATION_FILE_TEST
__C.TEST.BATCH_SIZE           = 2
__C.TEST.INPUT_SIZE           = 416
__C.TEST.DATA_AUG             = False
__C.TEST.DECTECTED_IMAGE_PATH = DEFAULT_YOLO_DETECTION_PATH
